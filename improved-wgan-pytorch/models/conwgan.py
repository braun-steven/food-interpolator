...
def set_dims(dim, output_dim):
    """Set the global dims for this module."""
    global DIM
    DIM = dim
    global OUTPUT_DIM
...
class MyConvo2d(nn.Module):
    def __init__(
        self, input_dim, output_dim, kernel_size, he_init=True, stride=1, bias=True
    ):
...
class DepthToSpace(nn.Module):
    ...
    def forward(self, input):
        ...
        t_1 = output.reshape(
            batch_size, input_height, input_width, self.block_size_sq, output_depth
        )
